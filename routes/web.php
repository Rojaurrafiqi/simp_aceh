...
Route::get('/admin/dashboard/mail/', [admin_controller::class, 'mail'])->name('mails')->middleware('is_admin');
...
Route::get('/admin/mail/disiarkan', [admin_controller::class, 'mail_disiarkan'])->name('mail_disiarkan')->middleware('is_admin');
Route::get('/admin/mail/revisi', [admin_controller::class, 'mail_revisi'])->name('mail_revisi')->middleware('is_admin');
Route::get('/admin/mail/rekap', [admin_controller::class, 'mail_rekap'])->name('mail_rekap')->middleware('is_admin');
