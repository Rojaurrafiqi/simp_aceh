                          ...
                          <br/>
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{route('mails')}}">Semua Berita</a>
                                    <a class="nav-link" href="{{route('mail_disetujui')}}">Disetujui</a>
                                    <a class="nav-link" href="{{route('mail_disiarkan')}}">Disiarkan</a>
                                    <a class="nav-link" href="{{route('mail_ditolak')}}">Ditolak</a>
                                    <a class="nav-link" href="{{route('mail_revisi')}}">Revisi</a>
                                </nav>
                            </div>
                           ...
                           <!-- <a class="nav-link" href="{{route('mail_disetujui')}}">
                            ...
                            <a class="nav-link" href="{{route('mail_ditolak')}}">
                                ...
                                Surat Ditolak
                            </a> --> <!-- dihilangkan, diganti menjadi berita masuk / edited 05/05/2021-->
