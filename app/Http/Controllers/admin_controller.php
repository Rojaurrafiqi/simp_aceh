...
class admin_controller extends Controller
{
    ...
    public function dashboard_detail_status_store(Request $request)
    {
        ...
        return redirect()->route('mails')->with('success', 'Data berhasil disimpan');
        //return redirect()->route('admin_dashboard_detail', ['nomor_surat' => $nomor_surat]);
    }

    public function mail()
    {
        $mails = DB::table('mails')->orderByDesc('created_at')->paginate(10);
        return view('admin.dashboard_mails')->with('mails', $mails);
    }
    ...
    public function mail_disiarkan()
    {
        $mails = DB::table('mails')->where('status', 'disiarkan')->paginate(10);
        return view('admin.mail_disiarkan')->with('mails', $mails);
    }
    ...
    public function mail_revisi ()
    {
        $mails = DB::table('mails')->where('status', 'revisi')->paginate(10);
        return view('admin.mail_revisi')->with('mails', $mails);
    }

    public function mail_rekap ()
    {
        //rekap bulanan
        return view('admin.mail_rekap');
    }
